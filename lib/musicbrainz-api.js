...
class MusicBrainzApi {
    ...
    */
    async mergeEntities(entity, targetid, mbids, editNote) {
        ...
        const r = await got_1.default.post(url, Object.assign({ 
            // body: queryString.stringify({ submit: 'cancel' }),
            form: { submit: 'cancel' }, followRedirect: false }, this.options));
        await this.rateLimiter.limit();
        ...
        const response = await got_1.default.post(url, Object.assign({ 
            // body: queryString.stringify(mergeFormData),
            form: mergeFormData, followRedirect: false }, this.options));
