...
class MusicBrainzApi {
    ...
    */
    async mergeEntities(entity, targetid, mbids) {
        ...
        const response = await got_1.default.post(url, Object.assign({ body: 'merge.merging.0=2496671&merge.merging.1=7588483&merge.merging.2=7588585&merge.edit_note=', followRedirect: false }, this.options));
